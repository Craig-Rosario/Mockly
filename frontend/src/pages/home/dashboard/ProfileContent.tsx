            ...
            <CardContent>
                <div className="flex items-start space-x-8 w-full">
                    ...
                    <div className="flex-1 flex justify-between">
                        <div className="pr-8">
                            <h4 className="text-2xl font-semibold text-white mb-1">Mockly Doe</h4>
                            <p className="text-purple-400 font-medium mb-2">Senior Software Engineer</p>
                            <p className="text-gray-300 mb-1">📍San Francisco, CA</p>
                            <p className="text-gray-300 mb-1">Email: mockly.doe@email.com</p>
                        </div>
