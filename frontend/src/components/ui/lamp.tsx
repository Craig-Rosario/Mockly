  ...
  return (
    <LampContainer>
      <motion.h1
        ...
        className="mt-8 bg-gradient-to-br from-[#5FA4E6] to-[#BA2193] py-4 bg-clip-text text-center text-4xl font-medium tracking-tight text-transparent md:text-7xl"
      >
        Overthink it Now <br /> Not When it Matters.
      </motion.h1>
    </LampContainer>
  );
}
      ...
      <div className="relative flex w-full flex-1 scale-y-125 items-center justify-center isolate z-0">
        ...
        <motion.div
          ...
          className="absolute inset-auto right-1/2 h-56 overflow-visible w-[30rem]
                     bg-gradient-conic from-[#5FA4E6] via-transparent to-transparent
        ...
        <motion.div
          ...
          className="absolute inset-auto left-1/2 h-56 w-[30rem]
                     bg-gradient-conic from-transparent via-transparent to-[#BA2193]
        ...
        <div className="absolute inset-auto z-50 h-36 w-[28rem] -translate-y-1/2 rounded-full 
                        bg-gradient-to-r from-[#5FA4E6] to-[#BA2193] opacity-50 blur-3xl"></div>
        ...
        <motion.div
          ...
          className="absolute inset-auto z-30 h-36 w-64 -translate-y-[6rem] rounded-full 
                     bg-gradient-to-r from-[#5FA4E6] to-[#BA2193] blur-2xl"
        ></motion.div>
        ...
        <motion.div
          ...
          className="absolute inset-auto z-50 h-0.5 w-[30rem] -translate-y-[7rem]
                     bg-gradient-to-r from-[#5FA4E6] to-[#BA2193]"
        ></motion.div>

        {/* Top blocker to hide beam edges */}
